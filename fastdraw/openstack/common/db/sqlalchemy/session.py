...
* Call set_defaults with the minimal of the following kwargs:
  ...
  Example:
    ...
    session.set_defaults(
        sql_connection="sqlite:///var/lib/fastdraw/sqlite.db",
        sqlite_db="/var/lib/fastdraw/sqlite.db")
...
from fastdraw.openstack.common.db import exception
from fastdraw.openstack.common.gettextutils import _  # noqa
from fastdraw.openstack.common import log as logging
from fastdraw.openstack.common import timeutils

sqlite_db_opts = [
    cfg.StrOpt('sqlite_db',
               default='fastdraw.sqlite',
    ...
    def _do_query(self, q):
        ...
        for file, line, method, function in traceback.extract_stack():
            ...
            if file.endswith('db/api.py'):
                continue
            # only trace inside fastdraw
            index = file.rfind('fastdraw')
            if index == -1:
                continue
