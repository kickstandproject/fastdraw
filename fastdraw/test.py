...
from fastdraw.common import paths
from fastdraw.db import migration
from fastdraw.openstack.common.db.sqlalchemy import session
...
CONF.import_opt(
    'connection', 'fastdraw.openstack.common.db.sqlalchemy.session',
    group='database'
)
CONF.import_opt('sqlite_db', 'fastdraw.openstack.common.db.sqlalchemy.session')
